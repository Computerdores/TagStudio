...
class SQLBoolExpressionBuilder(BaseVisitor[ColumnElement[bool]]):
    ...
    @override
    def visit_or_list(self, node: ORList) -> ColumnElement[bool]:  # type: ignore[misc]
    ...
    @override
    def visit_and_list(self, node: ANDList) -> ColumnElement[bool]:  # type: ignore[misc]
    ...
    @override
    def visit_constraint(self, node: Constraint) -> ColumnElement[bool]:  # type: ignore[misc]
    ...
    @override
    def visit_property(self, node: Property) -> ColumnElement[bool]:  # type: ignore[misc]
        raise NotImplementedError("This should never be reached!")

    @override
    def visit_not(self, node: Not) -> ColumnElement[bool]:  # type: ignore[misc]
